...
#'
#' @return the data.table with data and the column that gives the information about the response
#' @export
#'
#' @examples
#' importFrom data.table fread
read_data <- function(data.file, response.column, response.file = NULL, match.column = NULL){
  ...
  return(list(data = data, response.column = response.column))
}
